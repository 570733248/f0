...
class bfGetUrlListTennis():
    ...
    def getMarketIdList(self):
        ...
        req_json = {"filter":{"marketBettingTypes":["ASIAN_HANDICAP_SINGLE_LINE","ASIAN_HANDICAP_DOUBLE_LINE","ODDS"],"productTypes":["EXCHANGE"],"marketTypeCodes":["MATCH_ODDS","MATCH_ODDS_UNMANAGED","MONEYLINE","MONEY_LINE"],"contentGroup":{"language":"en","regionCode":"ASIA"},"turnInPlayEnabled":"true","maxResults":0,"selectBy":"FIRST_TO_START_AZ","eventTypeIds":[2]},"facets":[{"type":"EVENT_TYPE","skipValues":0,"maxValues":10,"next":{"type":"EVENT","skipValues":0,"maxValues":100,"next":{"type":"MARKET","maxValues":1,"next":{"type":"COMPETITION","maxValues":1}}}}],"currencyCode":"GBP","locale":"en_GB"}
    ...
    def jsonMarketIdList(self,data):
        ...
        for market in market_lists:
            ...
            if not status:
                ...
                if isToday == False and Diff > 3600:
                    pass
                else:
